...
class BorderBeam extends StatefulWidget {
  ...
  const BorderBeam({
    Key? key,
    required this.child,
    this.duration = 15, // Duration in seconds
...
class _BorderBeamState extends State<BorderBeam>
  ...
  void initState() {
    super.initState();
    // Initialize the controller with duration as a Duration object
    _controller = AnimationController(
      duration:
          Duration(seconds: widget.duration.toInt()), // Convert to Duration
      vsync: this,
    );
